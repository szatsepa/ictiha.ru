...
$out .= "НомерЗаявки;НомерСтроки;Артикул;Количество;СуммаСНДС;ИНН;НаименованиеКонтрагента;ЮрАдрес;ФактАдрес;Комментарий;НаименованиеНоменклатуры;Вес;СтавкаНДС;ОКПО;БанкРеквизиты;\n";

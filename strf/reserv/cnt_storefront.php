...
if($attributes[select]=='R' && isset($attributes[group]))$_SESSION[rubrika] = $attributes[group];
if($attributes[select]=='R' && $_SESSION[rubrika]==0)unset ($attributes[select]);
 unset($_SESSION[ok]);
...
//echo "$qry_images<br/>";
//
//echo "<br/>ST-'$attributes[stid]', SELECT-'$attributes[select]', GROUP-'$attributes[group]', SEARCH-'$attributes[search]'<br/>";
if(!$qry_images){

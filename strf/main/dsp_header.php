                ...
                <div class = "head">
                    <div class="head_logo">
                        <form action="index.php?act=look" method="post">
                             ...
                             <input type="image" src="http://shop.po-mera.ru/images/storefront/logo_<?php echo $attributes[stid];?>.jpg" title="На главную" alt="На главную"/>
                    
                        </form> 
                    </div>
                    <div class="head_frame">
                        
                         <img src="http://shop.po-mera.ru/images/storefront/H_<?php echo $attributes[stid];?>.jpg" width="635" height="120"  alt="верхний баннер"/>

...
?>                       
    ...
    <td valign="top" class="kab"><table border="0" cellpadding="5" cellspacing="5" width="230">
                ...
                foreach ($goods_arr as $row) { 
                  ...
                  <tr>
                      <td>
                          <a href='index.php?act=item_description&amp;artikul=<?php echo $row[str_code1];?>&amp;stid=<?php echo $st_id;?>&amp;price_id=<?php echo $row[pricelist_id];?>'><?php echo $row["str_name"];?></a>
                      </td>
                  </tr>
 ...
 <?php
                  ...
                  <tr>
                      <td>
                          <a href='index.php?act=item_description&amp;artikul=<?php echo $row[str_code1];?>&amp;stid=<?php echo $st_id;?>&amp;price_id=<?php echo $row[pricelist_id];?>'><?php echo $row["str_name"];?></a>&nbsp;<small><?php echo $row["num_amount"];?></small>
                      </td>
                  </tr>
                  <?php

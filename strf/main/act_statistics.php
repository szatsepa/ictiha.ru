...
<!--        <input type="hidden" name="user_id" value="<?php    echo $_POST['user_id'];?>"/> -->
     ...
     <script type="text/javascript">
        document.write (' <form action="index.php?act=look" method="post"><input type="hidden" name="stid" value="<?php echo $_POST['stid'];?>"/><input type="hidden" name="cod" value="<?php echo $cod;?>"/>');
